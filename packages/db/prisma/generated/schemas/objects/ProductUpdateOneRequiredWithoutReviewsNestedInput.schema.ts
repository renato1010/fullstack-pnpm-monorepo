...
const Schema: z.ZodType<Prisma.ProductUpdateOneRequiredWithoutReviewsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUpdateOneRequiredWithoutReviewsNestedInputObjectSchema =
  Schema;
