import {
  ...
  MapHttpErrorStatusToMessage,
  MapHttpSuccessStatusToMessage,
} from "./map-httpstatus-codes";
...
export interface HandlerSuccessResponse<
  SuccessCode extends SuccessStatus = 200,
  Data = Record<string, unknown>
> extends HandlerBasicResponse {
  ok: true;
  data: Data;
  status: SuccessCode;
}
export function getErrorResponse<ErrorCode extends ErrorStatus>(
  errorCode: ErrorCode
): HandlerErrorResponse<ErrorStatus> {
